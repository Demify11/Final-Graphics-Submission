...
vec3 vColour = BlinnPhongSpotlightModel (light[0], p, normalize(n)) + BlinnPhongSpotlightModel (light[1], p, normalize(n));
//vOutputColour = vec4(vColour, 1.0);
 /*vec3 vColour = vec3(0.0);
    for (int i = 0; i < 54; ++i) {
        vColour += BlinnPhongSpotlightModel(light[i], p, normalize(n));
    }*/
